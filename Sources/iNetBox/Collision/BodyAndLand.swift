...
extension World {
    /*
    mutating func collide(body a: Body, land b: Land) {
    ...
    private mutating func collideCircleAndCircle(_ a: Body, _ b: Land) {
        
    }

    private mutating func collideCircleAndBox(_ a: Body, _ b: Land) {
        assertionFailure("collideCircleAndBox not implemented")
    }

    private mutating func collideCircleAndCovex(_ a: Body, _ b: Land) {
        assertionFailure("collideCircleAndCovex not implemented")
    }

    private mutating func collideCircleAndComplex(_ a: Body, _ b: Land) {
        assertionFailure("collideCircleAndComplex not implemented")
    }
    
    private mutating func collideBoxAndBox(_ a: Body, _ b: Land) {
        assertionFailure("collideBoxAndBox not implemented")
    }
    
    private mutating func collideBoxAndCovex(_ a: Body, _ b: Land) {
        assertionFailure("collideBoxAndCovex not implemented")
    }
    
    private mutating func collideBoxAndComplex(_ a: Body, _ b: Land) {
        assertionFailure("collideBoxAndCovex not implemented")
    }
    
    private mutating func collideCovexAndCovex(_ a: Body, _ b: Land) {
        assertionFailure("collideCovexAndCovex not implemented")
    }
    
    private mutating func collideCovexAndComplex(_ a: Body, _ b: Land) {
        assertionFailure("collideCovexAndComplex not implemented")
    }
    
    private mutating func collideComplexAndComplex(_ a: Body, _ b: Land) {
